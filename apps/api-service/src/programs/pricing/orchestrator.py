...
def estimate_pricing(payload: Dict[str, Any]) -> Dict[str, Any]:
    ...
    response: Dict[str, Any] = {
        ...
        "visibleBandClamp": calibration_payload["visibleBandClamp"],
        "starterBaseline": calibration_payload["starterBaseline"],
        "medianPrice": calibration.normalized_service_range().midpoint(),
