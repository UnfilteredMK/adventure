  ...
  public: {
    Tables: {
      ...
      category_subcategory_seo: {
        ...
        Relationships: [
          {
            foreignKeyName: "category_subcategory_seo_category_subcategory_id_fkey"
      ...
      category_use_cases: {
        ...
        Relationships: [
          {
            foreignKeyName: "category_use_cases_category_id_fkey"
            columns: ["category_id"]
            isOneToOne: false
            referencedRelation: "categories"
            referencedColumns: ["id"]
      ...
      form_submissions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "form_submissions_subcategory_id_fkey"
      ...
      instance_config_versions: {
        ...
        Relationships: [
          {
            foreignKeyName: "instance_config_versions_instance_id_fkey"
            columns: ["instance_id"]
            isOneToOne: false
            referencedRelation: "instances"
            referencedColumns: ["id"]
    ...
    Enums: {
      ai_model_category_enum: "try-on" | "scene-placement"
